...
async function processLineByLine() {
  ...
  for await (const line of rl) {
    if (line.includes('mongorestore') || line.includes('mongoimport') || line.includes('mongoexport') || line.includes('mongodump')) {
  ...
  fs.writeFileSync('E:\\\\Dairy Walla\\\\dairy-setu\\\\scratch_find_mongo.txt', matches.join('\\n'));
