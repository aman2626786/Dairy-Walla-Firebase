...
async function processLineByLine() {
  ...
  for await (const line of rl) {
    if (line.includes('prisma.product.updateMany') || line.includes('prisma.product.update(')) {
  ...
  fs.writeFileSync('E:\\\\Dairy Walla\\\\dairy-setu\\\\scratch_find_update.txt', matches.join('\\n'));
